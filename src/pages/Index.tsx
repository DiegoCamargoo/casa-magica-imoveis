    ...
    <div className="min-h-screen">
      ...
      <section className="gradient-primary text-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-4xl md:text-6xl font-kophita font-bold mb-6 animate-fade-in">
            Encontre o Imóvel dos seus Sonhos
          </h1>
          <p className="text-xl md:text-2xl mb-8 text-gray-100 animate-fade-in font-montserrat">
            Especialistas em lançamentos imobiliários com as melhores oportunidades da cidade
          </p>
          <Button size="lg" variant="secondary" className="animate-fade-in font-montserrat font-medium">
            Ver Lançamentos
          </Button>
        </div>
      </section>
      ...
      <section className="py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-kophita font-bold text-center mb-12 text-gray-900">
          ...
          <div className="text-center mt-12">
            <Button size="lg" variant="outline" className="font-montserrat border-andrade-gold-500 text-andrade-gold-600 hover:bg-andrade-gold-50">
      ...
      <section className="py-16 gradient-dark text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl md:text-4xl font-kophita font-bold mb-6">
            Precisa Vender ou Alugar seu Imóvel?
          </h2>
          <p className="text-xl mb-8 text-gray-200 font-montserrat">
            Nossa equipe especializada em lançamentos está pronta para ajudar você
          </p>
          <div className="space-x-4">
            <Button size="lg" className="gradient-primary text-white font-montserrat font-medium">
              Anunciar Imóvel
            </Button>
            <Button size="lg" variant="outline" className="text-white border-white hover:bg-white hover:text-gray-800 font-montserrat">
              Falar com Corretor
            </Button>
          </div>
        </div>
